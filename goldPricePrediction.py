...
# CSV파일에서 데이터 불러오기
data_path = "C:/Users/data8316-14/Desktop/수업교재 & 파일/2학년 1학기/김진석 교수님/AI/데이터셋/Gold Price (2013-2023).csv"
df = pd.read_csv(data_path)

# 데이터 구조 확인을 위하여 처음 몇 행 표시
print(df.head())

# 'Data'열을 datatime 형식으로 변환
df['Date'] = pd.to_datetime(df['Date'])

# 날짜별로 데이터를 정렬하여 시간순으로 정렬
df = df.sort_values('Date')

# 'Data'열을 데이터 프레임의 index로 설정
...
# 가격 데이터를 신경망 입력에 대해 0과 1 범위로 축적
...
# Adam optimizer 와 평균 제곱 오차 손실 함수를 이용하여 모형 컴파일
